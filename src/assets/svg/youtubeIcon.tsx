...
export default function YoutubeIcon(props: SvgIconProps) {
    return (
        <SvgIcon {...props}>
            <svg id="Component_13_1" data-name="Component 13 – 1" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35">
                <g id="Ellipse_279" data-name="Ellipse 279" fill="none" stroke="#4f9a0a" strokeWidth="1">
